...
public class FaceRestSevice {
	...
	public Response register(@MultipartForm PersonForm form,
	...
	public View login(@MultipartForm PersonForm form,
			@Context HttpServletRequest request) {
		ApplicationContext ctx = new ClassPathXmlApplicationContext(
				"classpath:applicationContext.xml");
		...
		if (personList != null && !personList.isEmpty()) {
			...
			person.setImage(new org.apache.commons.codec.binary.Base64()
					.encode(personList.get(0).getImage1().getData()));
